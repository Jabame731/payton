...
def authenticate(selected_image, selected_password, selected_name):
    ...
    print(selected_name, selected_password, selected_image)
    ...
    filepath = "images/z_credentials.txt"  # File Path
    f = open(filepath, "r")
    name = ""
    password = ""
    image = ""
...
def create_canvas(window):
    ...
    img2 = (Image.open("images/" + imgList[num]))
    ...
    img3 = (Image.open("images/" + imgList[num + 3]))
    ...
    img4 = (Image.open("images/" + imgList[num + 6]))
